...
outside_range = ((fitted < 0) | (fitted > 1)).sum()
print(f"Number of predictions outside [0, 1]: {outside_range}")
print(f"Minimum fitted value: {fitted.min():.4f}")
print(f"Maximum fitted value: {fitted.max():.4f}")
